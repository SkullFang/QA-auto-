...
## 计算词频的例子
def com_tf():
    f = open('/Users/zhangyan/Desktop/Learning/BoP2017_DBAQ_dev_train_data/question.txt', 'r')
    data = f.readline()
    ...
    open('/Users/zhangyan/Desktop/Learning/BoP2017_DBAQ_dev_train_data/disquestion.txt', 'a').write(data3+'\n')  # 分词结果写入7temp.txt
